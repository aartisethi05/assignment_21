...
$(document).ready(function(){
  $('#recover').click(function(){
    ...
    (result.status==false)?alert('Email doesnot exist.'):$("#text").html(`Your password is : ${JSON.parse(result.password)} <br>Password in DB is : ${JSON.parse(result.original)} <br><a onclick="changePassword()" style="color:blue;text-decoration:underline;cursor:pointer">Click here </a>to change your password` ).show();
    }});
    }
  });
